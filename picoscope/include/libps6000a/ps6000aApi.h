...
typedef void (PREF4 *ps6000aStreamingReady)
(
	int16_t    						handle,
	int64_t     					noOfSamples,
...
// parameters:
// allChannelsTrippedStatus: raw pointer to an array of PICO_CHANNEL_OVERVOLTAGE_TRIPPED
// nChannelTrippedStatus: the number of allChannelsTrippedStatus in the array the function will fail
// if nChannelTrippedStatus does not match the number of analogue channels.
// return:
// PICO_INVALID_HANDLE,
// PICO_NULL_PARAMETER,
// PICO_INVALID_PARAMETER - nChannelTrippedStatus does not match number of channels
